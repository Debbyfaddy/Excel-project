...
1. Region by total sales
2. State by  soles
3. City by Sales
4. Retailer by Operating Profit
5. Product by units sold
6. Retailer by Units sold
7. Region by Units sold
8. City by Units sold
...
This data is telling a story  of the sales records of sportswear products  from different  retailers. It highlights different units of different products sold across different regions and cities and the revenue and profit generated from sales. 

DATA VISUALIZATION AND CHARTS

To present the analysis clearly and enable data-driven insights, a variety of visual tools were used:
Column & Bar Charts
Donut Chart
pie chart
...
This analysis provides a comprehensive understanding of Adidas’ sales performance across products, regions, retailers, and sales channels. The findings highlight strong seasonal trends, powerful regional demand patterns, and clear product category leaders—especially within men’s footwear. While online sales and the West region continue to drive overall growth, opportunities remain in underperforming months, regions, and retail segments.

By leveraging peak sales periods, strengthening high-performing markets, improving digital channels, and supporting underperforming retailers and categories, Adidas can significantly increase market share and revenue. Overall, these insights offer a strong foundation for strategic planning, targeted marketing, and smarter inventory decisions
